import { tasksArray, arrayChecker } from "./array-modified.js"
...
/*     if (!localStorage.getItem('myId')){ 
        ...
        localStorage.setItem('myId', `${parseInt(localStorage.getItem('myId') + 1)}`)
        arrayChecker()
        addLastTask()
        } */

    let myId = localStorage.getItem('myId') ? parseInt(localStorage.getItem('myId')) : 1;
    localStorage.setItem('myId', myId + 1);
    addLastTask()

    return {
        task: task,
        date: new Date(Date.parse(dateField)),
        id: parseInt(localStorage.getItem('myId')) + 1
    }
}
